...
export const handlerAppsEcommerce = [
    ...
    if (sortByLocal) {
      if (sortByLocal === 'product') {
        filteredProducts = filteredProducts.sort((a, b) => {
          if (orderByLocal === 'asc') return a.productName.toLowerCase() > b.productName.toLowerCase() ? 1 : -1;
          else if (orderByLocal === 'desc') return a.productName.toLowerCase() < b.productName.toLowerCase() ? 1 : -1;
      ...
      if (sortByLocal === 'price') {
        filteredProducts = filteredProducts.sort((a, b) => {
          if (orderByLocal === 'asc') return Number(a.price.slice(1)) > Number(b.price.slice(1)) ? 1 : -1;
          else if (orderByLocal === 'desc') return Number(a.price.slice(1)) < Number(b.price.slice(1)) ? 1 : -1;
  ...
  http.get('/api/apps/ecommerce/orders/:id', ({ params }) => {
    ...
    try {
      ...
      if (order) return HttpResponse.json(order, { status: 200 });
      else return HttpResponse.json('No invoice found with this id', { status: 404 });
    } catch (error) {
      return new HttpResponse(null, {
        status: 404,
      });
  ...
  http.get('/api/apps/ecommerce/orders', ({ request }) => {
    ...
    if (sortByLocal) {
      ...
      if (sortByLocal === 'date') {
        filterOrders.sort((a, b) => {
          if (orderByLocal === 'desc') return Number(new Date(b.date)) - Number(new Date(a.date));
  ...
  http.get('/api/apps/ecommerce/customers/:id', ({ params }) => {
    ...
    try {
      ...
      if (customer) return HttpResponse.json(customer, { status: 200 });
    } catch (error) {
      return new HttpResponse(null, {
        status: 404,
      });
  ...
  http.get('/api/apps/ecommerce/reviews', ({ request }) => {
    ...
    if (sortByLocal) {
      if (sortByLocal === 'product') {
        filteredReviews.sort((a, b) => {
          if (orderByLocal === 'asc') return a.product.toLowerCase() > b.product.toLowerCase() ? 1 : -1;
          else if (orderByLocal === 'desc') return a.product.toLowerCase() < b.product.toLowerCase() ? 1 : -1;
      ...
      if (sortByLocal === 'reviewer') {
        filteredReviews.sort((a, b) => {
          if (orderByLocal === 'asc') return a.reviewer.toLowerCase() > b.reviewer.toLowerCase() ? 1 : -1;
          else if (orderByLocal === 'desc') return a.reviewer.toLowerCase() < b.reviewer.toLowerCase() ? 1 : -1;
      ...
      if (sortByLocal === 'date') {
        filteredReviews.sort((a, b) => {
          if (orderByLocal === 'desc') return Number(new Date(b.date)) - Number(new Date(a.date));
          else if (orderByLocal === 'asc') return Number(new Date(a.date)) - Number(new Date(b.date));
    ...
    if (sortByLocal === 'status') {
      filteredReviews.sort((a, b) => {
        if (orderByLocal === 'asc') return a.status.toLowerCase() > b.status.toLowerCase() ? 1 : -1;
        else if (orderByLocal === 'desc') return a.status.toLowerCase() < b.status.toLowerCase() ? 1 : -1;
        else return 0;
      });
    }
  ...
  http.get('/api/apps/ecommerce/referrals', ({ request }) => {
    ...
    if (sortByLocal) {
      ...
      if (sortByLocal === 'earning') {
        filteredReferrals.sort((a, b) => {
          if (orderByLocal === 'asc') return Number(a.earning.slice(1)) - Number(b.earning.slice(1));
          else if (orderByLocal === 'desc') return Number(b.earning.slice(1)) - Number(a.earning.slice(1));
      ...
      if (sortByLocal === 'value') {
        filteredReferrals.sort((a, b) => {
          if (orderByLocal === 'asc') return Number(a.value.slice(1)) - Number(b.value.slice(1));
          else if (orderByLocal === 'desc') return Number(b.value.slice(1)) - Number(a.value.slice(1));
