...
<template>
  <VCard title="Outlined Timeline">
    <VCardText>
      <VTimeline side="end" align="start" line-inset="8" truncate-line="start" density="compact" class="v-timeline--variant-outlined">
          ...
          <div class="d-flex justify-space-between align-center flex-wrap">
            ...
            <div class="d-flex align-center mt-2">
              ...
              <div class="d-flex flex-column">
                <p class="text-sm font-weight-medium text-medium-emphasis mb-0">Lester McCarthy (Client)</p>
        ...
        <VTimelineItem size="x-small" dot-color="rgb(var(--v-theme-surface))">
          ...
          <div class="v-avatar-group demo-avatar-group">
            ...
            <VAvatar :size="40" :color="$vuetify.theme.current.dark ? '#373b50' : '#eeedf0'"> +3 </VAvatar>
          </div>
        </VTimelineItem>
        <!-- !SECTION -->
      </VTimeline>
