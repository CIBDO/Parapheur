...
<template>
  <div class="my-6">
    <div>
      <h5 class="text-h5">Timeline with icons</h5>
    </div>
    <VTimeline
      align="start"
      line-inset="19"
    ...
    >
        ...
        <VCard class="mb-10 mt-n4">
          ...
          <VCardText>
            ...
            <p class="app-timeline-text mb-3">
              he process of recording the key project details and producing the documents that are required to implement it successfully.
              Simply put, it's an umbrella term which includes all the documents created over the course of the project.
            </p>
            <div class="d-inline-flex align-items-center timeline-chip">
              <img :src="pdf" height="20" class="me-2" alt="img" />
              <span class="app-timeline-text font-weight-medium"> documentation.pdf </span>
            </div>
          </VCardText>
        </VCard>
      </VTimelineItem>
      ...
      <VTimelineItem fill-dot size="small">
        ...
        <VCard class="mb-10 mt-n4">
          ...
          <VCardText>
            <p class="mb-3">In the Select Image for Project dialog box, choose one of the following: Under the Upload New Image section</p>
          ...
          <VCardText>
            <div>
              <div class="d-flex align-center mb-3">
                ...
                <div>
                  <h6 class="text-h6">Loretta Moore</h6>
                  <div class="text-body-2">CTO of Airbnb</div>
                </div>
              </div>
              ...
              <div class="text-body-1">
                I wish I could select more than one main reason for rating this. I love how they constantly work on to make the template
                better. I am so thankful for this. Also, in the past, they had responded well to my tickets. Thank you for this great theme,
                for such an amazing support, for the better updates. I wish I could rate this for so many times. I highly recommend this
                template!
              </div>
            </div>
          </VCardText>
        ...
        <VCard class="mb-10 mt-n4">
          ...
          <VCardText>
            <div class="mb-3">
              ...
              <div class="text-body-2">Compared to $84,325 last year</div>
            </div>
      ...
      <VTimelineItem fill-dot size="small">
        ...
        <VCard class="mb-10 mt-n4">
          ...
          <VCardText>
            <p class="mb-3">
              The structure and process are defined in the project organization considering the attainment of the corporate objectives and
              therefore also project objectives. The components of the project process are
            </p>
            <div class="d-inline-flex align-items-center timeline-chip mb-3">
              <img :src="xls" height="20" class="me-2" alt="img" />
              <span class="app-timeline-text font-weight-medium"> progress-report.xls </span>
            </div>
            <div class="d-flex gap-2 align-center">
              <div class="flex-grow-1">
                <VProgressLinear :model-value="34" color="primary" />
              </div>
              <div class="text-body-2 font-weight-medium">34%</div>
            </div>
          </VCardText>
        </VCard>
      </VTimelineItem>
