      ...
      <VExpansionPanelText>
        <VForm class="pt-4 pb-2" @submit.prevent="() => {}">
          <VRow>
            ...
            <!-- 👉 Phone No -->
            <VCol cols="12" md="6">
              <AppTextField label="Phone No" type="number" placeholder="+1 123 456 7890" />
            </VCol>
            <!-- 👉 Address -->
            <VCol cols="12">
    ...
    <VExpansionPanel>
      ...
      <VExpansionPanelText>
        ...
        <VRadioGroup v-model="deliveryOption" class="delivery-options pt-4 pb-2">
          ...
          <div class="delivery-option d-flex" :class="deliveryOption === 'express' ? 'active' : ''" @click="deliveryOption = 'express'">
            ...
            <VForm class="pt-4 pb-2">
              ...
              <div>
                <VRadioGroup v-model="paymentMethod" inline>
                  <div>
                    <VRadio v-for="payment in paymentMethods" :key="payment.radioValue" :value="payment.radioValue" class="me-3">
                      <template #label>
              ...
              <VRow v-else>
                <VCol>
                  <div class="text-high-emphasis">
                    Cash on Delivery is a type of payment method where the recipient make payment for the order at the time of delivery
