...
<template>
  <div class="demo-space-x">
    ...
    <VSwitch v-model="switchOnDisabled" value="on" disabled label="On disabled" />

    <VSwitch disabled label="Off disabled" />

    <VSwitch v-model="switchOnLoading" loading="warning" :label="`${switchOnLoading ? 'On' : 'Off'} loading`" />
  </div>
</template>
