    ...
    <div class="pa-6 flex-grow-1">
      <VRow>
        ...
        <VCol cols="12" md="2" sm="4">
          <AppTextField id="item-cost" v-model="localProductData.cost" type="number" placeholder="Cost" class="mb-6" />
        ...
        <VCol cols="12" md="2" sm="4">
          <AppTextField id="item-hours" v-model="localProductData.hours" type="number" placeholder="5" />
        </VCol>
        <VCol cols="12" md="2" sm="4">
          <p class="my-2">
