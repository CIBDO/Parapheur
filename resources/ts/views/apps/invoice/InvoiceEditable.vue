  ...
  <VCard class="pa-6 pa-sm-12">
      ...
      <div class="d-flex flex-column gap-2">
        ...
        <div class="d-flex gap-x-4 align-start align-sm-center flex-column flex-sm-row">
          ...
          <span style="min-inline-size: 9.5rem">
            <AppDateTimePicker id="due-date" v-model="invoice.dueDate" placeholder="YYYY-MM-DD" :config="{ position: 'auto right' }" />
          </span>
        </div>
      </div>
    </div>
    ...
    <VRow>
      <VCol class="text-no-wrap">
        ...
        <p v-if="invoice.client.address" class="mb-0">{{ invoice.client.address }}, {{ invoice.client.country }}</p>
        <p class="mb-0">
    ...
    <div class="add-products-form">
      ...
      <VBtn size="small" prepend-icon="tabler-plus" @click="addItem"> Add Item </VBtn>
    </div>
