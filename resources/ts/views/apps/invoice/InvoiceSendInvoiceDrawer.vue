      ...
      <VCard flat>
        <VCardText>
          <VForm @submit.prevent="onSubmit">
            <VRow>
              <VCol cols="12">
                <AppTextField id="sender-email" v-model="emailFrom" label="From" placeholder="sender@email.com" />
              </VCol>

              <VCol cols="12">
                <AppTextField id="receiver-email" v-model="emailTo" label="To" placeholder="receiver@email.com" />
              </VCol>
              ...
              <VCol cols="12">
                ...
                <VBtn color="secondary" variant="tonal" @click="$emit('update:isDrawerOpen', false)"> Cancel </VBtn>
              </VCol>
            </VRow>
          </VForm>
        </VCardText>
