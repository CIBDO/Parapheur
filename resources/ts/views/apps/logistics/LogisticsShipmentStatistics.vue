...
<template>
  <VCard>
    <VCardItem title="Shipment statistics" subtitle="Total number of deliveries 23.8k">
      <template #append>
    ...
    <VCardText>
      <VueApexCharts id="shipment-statistics" type="line" height="320" :options="shipmentConfig" :series="series" />
    </VCardText>
  </VCard>
</template>
