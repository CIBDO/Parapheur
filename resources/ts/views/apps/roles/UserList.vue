...
const resolveUserRoleVariant = (role: string) => {
  ...
  if (roleLowerCase === 'subscriber') return { color: 'primary', icon: 'tabler-user' };
  if (roleLowerCase === 'author') return { color: 'warning', icon: 'tabler-settings' };
  if (roleLowerCase === 'maintainer') return { color: 'success', icon: 'tabler-chart-donut' };
  if (roleLowerCase === 'editor') return { color: 'info', icon: 'tabler-pencil' };
  if (roleLowerCase === 'admin') return { color: 'error', icon: 'tabler-device-laptop' };
