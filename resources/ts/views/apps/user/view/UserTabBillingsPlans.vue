  ...
  <VRow>
        ...
        <VCardText>
          <VRow>
            ...
            <VCol cols="12" md="6" order-md="2" order="1">
              ...
              <p class="text-sm mt-1">Your plan requires update</p>
            </VCol>
    ...
    <VCol cols="12">
      <VCard title="Payment Methods">
        <template #append>
          <VBtn prepend-icon="tabler-plus" size="small" @click="isCardAddDialogVisible = !isCardAddDialogVisible"> Add Card </VBtn>
        </template>
            ...
            <VCardText class="d-flex flex-sm-row flex-column gap-6 justify-space-between">
              ...
              <div class="d-flex flex-column text-sm-end gap-y-4">
                <div class="order-sm-0 order-1">
                  <VBtn variant="tonal" size="small" class="me-4" @click="openEditCardDialog(card)"> Edit </VBtn>
    ...
    <VCol cols="12">
      ...
      <VCard title="Billing Address">
        <template #append>
          <VBtn size="small" prepend-icon="tabler-plus" @click="isEditAddressDialogVisible = !isEditAddressDialogVisible">
            Edit Address
          </VBtn>
        </template>
