...
<template>
  ...
  >
    <!-- 👉 Header -->
    <AppDrawerHeaderSection :title="event.id ? 'Update Event' : 'Add Event'" @cancel="$emit('update:isDrawerOpen', false)">
        ...
        <VCardText>
          ...
          <VForm ref="refForm" @submit.prevent="handleSubmit">
            <VRow>
              ...
              <VCol cols="12">
                ...
                >
                  <template #selection="{ item }">
                    <div v-show="event.extendedProps.calendar" class="align-center" :class="event.extendedProps.calendar ? 'd-flex' : ''">
              ...
              <!-- 👉 All day -->
              <VCol cols="12">
                <VSwitch id="event-all-day" v-model="event.allDay" label="All day" />
              </VCol>
              ...
              <!-- 👉 Location -->
              <VCol cols="12">
                <AppTextField id="event-location" v-model="event.extendedProps.location" label="Location" placeholder="Meeting room" />
              </VCol>
