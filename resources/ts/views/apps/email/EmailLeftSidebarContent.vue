...
<template>
  <div class="d-flex flex-column h-100">
    ...
    <div class="px-6 pb-5 pt-6">
      <VBtn block @click="$emit('toggleComposeDialogVisibility')"> Compose </VBtn>
    </div>
    ...
    <PerfectScrollbar :options="{ wheelPropagation: false }" class="h-100">
      ...
      <ul class="email-filters py-4">
        ...
        >
          ...
          >
            ...
            <VChip v-if="folder.badge?.content" :color="folder.badge.color" label size="small" class="rounded-xl px-3">
      ...
      <ul class="email-labels py-4">
        <!-- 👉 Labels -->
        <div class="text-caption text-disabled mb-4 px-6">LABELS</div>
        <RouterLink
        ...
        >
          <li
            ...
            @click="navigate"
          >
            <VIcon icon="tabler-circle-filled" :color="label.color" class="me-2" size="12" />
