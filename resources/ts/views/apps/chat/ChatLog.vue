...
const resolveFeedbackIcon = (feedback: ChatOut['messages'][number]['feedback']) => {
  ...
  else if (feedback.isDelivered) return { icon: 'tabler-checks', color: undefined };
...
<template>
  <div class="chat-log pa-6">
    ...
    >
      ...
      <div class="chat-body d-inline-flex flex-column" :class="msgGrp.senderId !== contact.id ? 'align-end' : 'align-start'">
        <div
