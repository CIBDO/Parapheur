      ...
      <div class="text-medium-emphasis chat-settings-section">
        ...
        <div class="d-flex align-center pa-2">
          ...
          <div class="text-high-emphasis d-flex align-center justify-space-between flex-grow-1">
            ...
            <VSwitch id="two-step-verification" v-model="isAuthenticationEnabled" density="compact" />
          </div>
        </div>
        <div class="d-flex align-center pa-2">
          ...
          <div class="text-high-emphasis d-flex align-center justify-space-between flex-grow-1">
            ...
            <VSwitch id="chat-notification" v-model="isNotificationEnabled" density="compact" />
          </div>
        </div>
        <div class="d-flex align-center pa-2">
