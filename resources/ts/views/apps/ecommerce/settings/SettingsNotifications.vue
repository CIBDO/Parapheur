...
<template>
  <VCard class="mb-4">
    <VCardText>
      <h5 class="text-h5 mb-2">Customer</h5>
      <VTable class="text-no-wrap mb-6 border rounded">
        ...
        <tbody>
          <tr v-for="notification in customerNotifications" :key="notification.type">
            <td width="400px" class="text-high-emphasis">
              {{ notification.type }}
            </td>
            <td>
      ...
      <h5 class="text-h5 mb-2">Orders</h5>
      <VTable class="text-no-wrap mb-6 border rounded">
        <thead>
          <tr>
            <th scope="col">TYPE</th>
        ...
        <tbody>
          <tr v-for="notification in ordersNotification" :key="notification.type">
            <td width="400px" class="text-high-emphasis">
              {{ notification.type }}
            </td>
            <td>
      ...
      <h5 class="text-h5 mb-2">Shipping</h5>
      <VTable class="text-no-wrap mb-6 border rounded">
        <thead>
          <tr>
            <th scope="col">TYPE</th>
        ...
        <tbody>
          <tr v-for="notification in shippingNotifications" :key="notification.type">
            <td width="400px" class="text-high-emphasis">
              {{ notification.type }}
            </td>
            <td>
