...
<template>
  <VCard title="Customer contact method" subtitle="Select what contact method customers use to check out." class="mb-6">
    <VCardText>
      ...
      <VAlert type="info" variant="tonal">
        <VAlertTitle class="mb-0"> To send SMS updates, you need to install an SMS App. </VAlertTitle>
      </VAlert>
    </VCardText>
  </VCard>
  ...
  <VCard title="Customer information" class="mb-6">
    <VCardText class="customer-info-card">
      <VRadioGroup v-model="fullName" label="Full name" class="mb-4">
        ...
        <VRadio value="Require first and last name" label="Require first and last name" />
      </VRadioGroup>
      ...
      <VRadioGroup v-model="addressLine" label="Address line 2 (apartment, unit, etc.)" class="mb-4">
        <VRadio value="Don't include" label="Don't include" />
        <VRadio value="Optional" label="Optional" />
        <VRadio value="Required" label="Required" />
      </VRadioGroup>

      <VRadioGroup v-model="shippingAddress" label="Shipping address phone number" class="mb-4">
        <VRadio value="Don't include" label="Don't include" />
        <VRadio value="Optional" label="Optional" />
        <VRadio value="Required" label="Required" />
      </VRadioGroup>
