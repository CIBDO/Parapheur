...
<template>
    ...
    <VCol cols="12">
      <VCard v-if="props.customerData">
        <VCardText class="text-center pt-12">
          ...
          <div class="text-body-1">Customer ID #{{ props.customerData.customerId }}</div>
          ...
          <div class="d-flex justify-space-evenly gap-x-5 mt-6">
            <div class="d-flex align-center">
              ...
              <div class="d-flex flex-column align-start">
                ...
                <div class="text-body-1">Order</div>
              </div>
            </div>
            <div class="d-flex align-center">
              ...
              <div class="d-flex flex-column align-start">
                <h5 class="text-h5">${{ props.customerData.totalSpent }}</h5>
        ...
        <VCardText class="text-center">
          <VBtn block @click="isUserInfoEditDialogVisible = !isUserInfoEditDialogVisible"> Edit Details </VBtn>
        </VCardText>
      </VCard>
    </VCol>
    <!-- !SECTION -->
    ...
    <VCol cols="12">
      <VCard flat class="current-plan">
        <VCardText>
          <div class="d-flex align-center">
            <div>
              <h5 class="text-h5 text-white mb-4">Upgrade to premium</h5>
              <p class="mb-6 text-wrap">Upgrade customer to premium membership to access pro features.</p>
            </div>
            <div>
              <VImg :src="rocketImg" height="108" width="108" />
            </div>
          </div>
          <VBtn color="#fff" class="text-primary" block @click="isUpgradePlanDialogVisible = !isUpgradePlanDialogVisible">
            Upgrade to Premium
          </VBtn>
        </VCardText>
      </VCard>
  ...
  <UserInfoEditDialog v-model:is-dialog-visible="isUserInfoEditDialogVisible" :user-data="customerData" />
