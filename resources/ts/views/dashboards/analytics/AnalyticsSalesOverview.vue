<template>
  <VCard>
    ...
    <VCardText>
      <VRow no-gutters>
        ...
        <VCol cols="2">
          <div class="d-flex flex-column align-center justify-center h-100">
            ...
            <VAvatar size="24" color="rgba(var(--v-theme-on-surface), var(--v-hover-opacity))" class="my-2">
      ...
      <div class="mt-6">
        <VProgressLinear model-value="72" color="#00CFE8" height="10" bg-color="primary" :rounded-bar="false" rounded />
      </div>
    </VCardText>
  </VCard>
</template>
