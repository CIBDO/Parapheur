    ...
    <VRow no-gutters>
      <VCol cols="12" sm="8" lg="8" :class="$vuetify.display.smAndUp ? 'border-e' : 'border-b'">
        <VCardText>
          ...
          <VueApexCharts :options="chartOptions.bar" :series="series.bar" height="365" />
        </VCardText>
      </VCol>
        ...
        <VCardText class="d-flex flex-column justify-center align-center text-center h-100">
          <VBtn variant="tonal" size="small" class="d-flex mx-auto">
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem v-for="(item, index) in ['2021', '2020', '2019']" :key="index" :value="index">
          ...
          <VueApexCharts :options="chartOptions.line" :series="series.line" height="100" />
