    ...
    <div class="customer-reviews">
        ...
        <VRow>
          <VCol cols="12" md="3">
            <div class="headers d-flex justify-center flex-column align-start h-100" style="max-inline-size: 275px">
              <VChip label color="primary" class="mb-4" size="small"> Real Customers Reviews </VChip>
              <div class="position-relative mb-1 me-2">
                <div class="section-title">What people say</div>
              </div>
              <p class="text-body-1 mb-12">See what our customers have to say about their experience.</p>
              <div class="position-relative">
                <IconBtn class="reviews-button-prev rounded me-4" variant="tonal" color="primary" @click="slide('prev')">
                ...
                <swiper-slide v-for="(data, index) in reviewData" :key="index">
                  <VCard class="d-flex h-100 align-stretch">
                    <VCardText class="pa-6 d-flex flex-column justify-space-between align-start">
                      ...
                      <VRating :model-value="data.rating" color="warning" density="compact" class="mb-4" readonly />
      ...
      <VContainer>
        ...
        <div class="swiper-brands-carousel">
          ...
          >
            <swiper-slide v-for="(img, index) in [brandLogo1, brandLogo2, brandLogo3, brandLogo4, brandLogo5]" :key="index">
