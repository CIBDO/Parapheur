      ...
      <div class="landing-hero" :class="theme.current.value.dark ? 'landing-hero-dark-bg' : 'landing-hero-light-bg'">
        <VContainer>
          <div class="hero-text-box text-center px-6">
            <h1 class="hero-title mb-4">One dashboard to manage all your business</h1>
            <h6 class="mb-6 text-h6">Production-ready & easy to use Admin Template for Reliability and Customizability.</h6>
