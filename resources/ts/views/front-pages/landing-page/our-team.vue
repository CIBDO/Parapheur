  ...
  <VContainer id="team">
    <div class="our-team pa-">
      <div class="headers d-flex justify-center flex-column align-center">
        <VChip label color="primary" class="mb-4" size="small"> Our Great Team </VChip>

        <h4 class="d-flex align-center text-h4 mb-1 flex-wrap justify-center">
          <div class="position-relative me-2">
            <div class="section-title">Supported</div>
          </div>
          by Real People
        </h4>

        <p class="text-center text-body-1 mb-0">Who is behind these great-looking interfaces?</p>
      </div>
