            ...
            <div class="footer-links">
              ...
              <ul style="list-style: none">
                <li v-for="(item, index) in pagesList" :key="index" class="mb-4">
                  <RouterLink :class="$vuetify.theme.current.dark ? 'text-body-1' : 'text-white-variant'" class="me-2" :to="item.to">
                    {{ item.name }}
                  </RouterLink>
                  ...
                  <template #default>
                    <div class="d-flex align-center gap-x-8 footer-logo-buttons">
                      ...
                      <div class="d-flex flex-column justify-content-start">
                        <div :class="$vuetify.theme.current.dark ? 'text-body-2' : 'text-white-variant text-body-2'">Download on the</div>
      ...
      <VContainer>
        <div class="d-flex justify-space-between flex-wrap gap-y-5 align-center">
          <div class="text-body-1 text-white-variant text-wrap me-4">
            ...
            <a href="https://pixinvent.com/" target="_blank" rel="noopener noreferrer" class="font-weight-bold ms-1 text-white">Pixinvent</a
