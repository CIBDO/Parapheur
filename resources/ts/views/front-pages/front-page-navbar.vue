    ...
    <PerfectScrollbar :options="{ wheelPropagation: false }" class="h-100">
      ...
      <div>
        <div class="d-flex flex-column gap-y-4 pa-4">
          ...
          <div class="font-weight-medium cursor-pointer">
            ...
            <div class="px-4" :class="isMenuOpen ? 'd-block' : 'd-none'">
              <div v-for="(item, index) in menuItems" :key="index">
                ...
                <ul class="mb-6">
                  <li v-for="listItem in item.navItems" :key="listItem.name" style="list-style: none" class="text-body-1 mb-4 text-no-wrap">
                    <RouterLink
                      :to="listItem.to"
          ...
          <RouterLink to="/" target="_blank" class="font-weight-medium nav-link"> Admin </RouterLink>
        </div>
      </div>
