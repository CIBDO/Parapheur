        ...
        <VCardText>
          <VRow>
            <VCol cols="12" md="6">
              <div>
                <div class="mb-6">
                  <h3 class="text-body-1 text-high-emphasis font-weight-medium mb-1">Your Current Plan is Basic</h3>
                  <p class="text-body-1">A simple start for everyone</p>
                </div>

                <div class="mb-6">
                  <h3 class="text-body-1 text-high-emphasis font-weight-medium mb-1">Active until Dec 09, 2021</h3>
                  <p class="text-body-1">We will send you a notification upon Subscription expiration</p>
                </div>
                ...
                <div>
                  ...
                  <p class="text-base mb-0">Standard plan for small to medium businesses</p>
                </div>
              </div>
            </VCol>
            ...
            <VCol cols="12" md="6">
              ...
              <p class="text-body-2 mt-1 mb-0">18 days remaining until your plan requires update</p>
            </VCol>
            ...
            <VCol cols="12">
              <div class="d-flex flex-wrap gap-4">
                ...
                <VBtn color="error" variant="tonal" @click="isConfirmDialogVisible = true"> Cancel Subscription </VBtn>
              </div>
            </VCol>
          </VRow>
            ...
            <VRow>
                ...
                <VRow>
                  ...
                  <VCol cols="12">
                    <VRadioGroup v-model="selectedPaymentMethod" inline>
                      <VRadio value="credit-debit-atm-card" label="Credit/Debit/ATM Card" color="primary" class="me-6" />
                  ...
                  <VCol cols="12">
                    <VRow>
                      <!-- 👉 Card Number -->
                      <VCol cols="12">
                        <AppTextField v-model="cardNumber" label="Card Number" placeholder="1234 1234 1234 1234" type="number" />
                      </VCol>
                      ...
                      <VCol cols="12">
                        <VSwitch v-model="isCardDetailSaveBilling" density="compact" label="Save card for future billing?" />
                      </VCol>
                    </VRow>
                  </VCol>
                  <VCol cols="12" class="d-flex flex-wrap gap-4">
                    <VBtn type="submit"> Save changes </VBtn>
                    <VBtn color="secondary" variant="tonal" @click="resetPaymentForm"> Cancel </VBtn>
                  </VCol>
                </VRow>
              </VCol>
              ...
              <VCol cols="12" md="6">
                ...
                <div class="d-flex flex-column gap-y-6">
                  <VCard v-for="card in creditCards" :key="card.name" flat color="rgba(var(--v-theme-on-surface),var(--v-hover-opacity))">
                    <VCardText class="d-flex flex-sm-row flex-column">
                      <div class="text-no-wrap">
                        ...
                        <h4 class="my-2 text-body-1 text-high-emphasis d-flex align-center">
                          ...
                          <VChip v-if="card.isPrimary" label color="primary" size="small"> Primary </VChip>
                        </h4>
                        <div class="text-body-1">**** **** **** {{ card.number.substring(card.number.length - 4) }}</div>
                      </div>
                      ...
                      <div class="d-flex flex-column text-sm-end">
                        <div class="d-flex flex-wrap gap-4 order-sm-0 order-1">
                          <VBtn variant="tonal" size="small" @click="openEditCardDialog(card)"> Edit </VBtn>
                ...
                <CardAddEditDialog v-model:is-dialog-visible="isCardEditDialogVisible" :card-details="currentCardDetails" />
              </VCol>
            </VRow>
          </VForm>
        </VCardText>
