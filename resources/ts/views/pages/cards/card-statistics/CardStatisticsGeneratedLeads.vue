    ...
    <VCardText class="d-flex justify-space-between">
      <div class="d-flex flex-column">
        <div class="mb-auto">
          ...
          <div class="text-body-1">Monthly Report</div>
        </div>

        <div>
          <h3 class="text-h3">4,350</h3>
          <div class="d-flex gap-x-1 align-center">
            <VIcon icon="tabler-chevron-up" size="20" color="success" />
            <div class="text-base text-success">15.8%</div>
          </div>
        </div>
      </div>
      <div>
        <VueApexCharts :options="chartOptions" :series="series" :height="147" :width="130" />
      </div>
    </VCardText>
  </VCard>
</template>
