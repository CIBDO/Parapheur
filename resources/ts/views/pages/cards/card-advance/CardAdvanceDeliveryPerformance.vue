      ...
      <VList class="card-list">
        <VListItem v-for="(data, index) in deliveryData" :key="index">
          <div class="d-flex gap-x-4 align-center">
            <VAvatar :color="data.color" variant="tonal" rounded size="38" class="me-1">
            ...
            <div>
              ...
              <VListItemSubtitle>
                <div :class="data.change > 0 ? 'text-success' : 'text-error'" class="d-flex align-center">
                  <VIcon :icon="data.change > 0 ? 'tabler-chevron-up' : 'tabler-chevron-down'" class="me-1" size="20" />
