  ...
  <VRow>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard>
        ...
        <VCardText>
          Cancun is back, better than ever! Over a hundred Mexico resorts have reopened and the state tourism minister predicts Cancun will
          draw as many visitors in 2006 as it did two years ago.
        </VCardText>
      </VCard>
    </VCol>
        ...
        <VCardText class="position-relative">
          ...
          <div class="d-flex justify-space-between align-center mt-8">
            ...
            <div class="v-avatar-group">
              <VAvatar v-for="avatar in avatars" :key="avatar" :image="avatar" size="38" />
            </div>
          </div>
        </VCardText>
      </VCard>
        ...
        <VExpandTransition>
          <div v-show="isCardDetailsVisible">
            ...
            <VCardText>
              ...
              not with all the bed making you'll be doing. Then we'll go with that data file! Hey, you add a one and two zeros to that or we
      ...
      <VCard>
        <div class="d-flex justify-space-between flex-wrap flex-md-nowrap flex-column flex-md-row">
          ...
          <div>
            ...
            <VCardText> Apple iPhone 11 Pro smartphone. Announced Sep 2019. Features 5.8″ display Apple A13 Bionic </VCardText>

            <VCardText class="text-subtitle-1"> <span>Price :</span> <span class="font-weight-medium">$899</span> </VCardText>
        ...
        <VRow no-gutters>
          <VCol cols="12" sm="8" md="12" lg="7" order="2" order-lg="1">
            ...
            <VCardText>
              ...
              body muscles and holding ones own breath. Though, most of these notes are not fundamentally necessary, they are such that you
              can use them for a good laugh, at a drinks party or for picking up women or men.
            </VCardText>
    ...
    <VCol cols="12" lg="4" md="6">
      <VCard title="Influencing The Influencer">
        <VCardText>
          ...
          while delivery people scan bar codes with handhelds and workers in the field stay in touch.
        </VCardText>

        <VCardText> If you're in the market for new desktops, notebooks, or PDAs, there are a myriad of choices. </VCardText>
    ...
    <VCol cols="12" lg="4" md="6">
      <VCard title="The Best Answers">
        ...
        <VCardText>
          If you are looking for a new way to promote your business that won't cost you more money, maybe printing is one of the options you
          won't resist.
        </VCardText>
    ...
    <VCol cols="12" md="6" lg="4">
      <VCard class="text-center">
        ...
        <VCardText>
          <p>
            According to us blisters are a very common thing and we come across them very often in our daily lives. It is a very common
            occurrence like cold or fever depending upon your lifestyle.
          </p>
        </VCardText>
