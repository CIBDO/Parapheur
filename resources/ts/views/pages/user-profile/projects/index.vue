      ...
      <VCard>
        ...
        <VCardText>
          <div class="d-flex align-center justify-space-between flex-wrap gap-2">
            ...
            <VChip label :color="data.chipColor" size="small"> {{ data.daysLeft }} Days left </VChip>
          </div>
          ...
          <VProgressLinear rounded rounded-bar height="8" :model-value="data.completedTask" :max="data.totalTask" color="primary" />
