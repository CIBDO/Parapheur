    ...
    <VCardText>
      <VRow no-gutters>
        ...
        <VCol cols="12" md="10" class="mb-6">
          <p class="text-subtitle-1 mb-1">Cupcake ipsum dolor sit amet fruitcake donut chocolate.</p>
          <span>font-size: 0.9375rem / line-height: 1.375rem / font-weight: 400</span>
        </VCol>

        <VCol cols="12" md="2">
          <p class="text-subtitle-2">text-subtitle-2</p>
        </VCol>
        <VCol cols="12" md="10" class="mb-6">
        ...
        <VCol cols="12" md="10">
          <p class="text-button mb-1">Cupcake ipsum dolor sit amet fruitcake donut chocolate.</p>
