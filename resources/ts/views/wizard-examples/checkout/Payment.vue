      ...
      <VWindow v-model="selectedPaymentMethod" style="max-inline-size: 600px" :touch="false">
        <VWindowItem value="card" class="ms-n3">
          <VForm class="mt-3">
            <VRow class="ma-0 pa-n2">
              <VCol cols="12">
                <AppTextField v-model="cardFormData.cardNumber" type="number" label="Card Number" placeholder="1356 3215 6548 7898" />
              </VCol>
              ...
              <VCol cols="12" class="pt-1">
                ...
                <div class="mt-4">
                  <VBtn class="me-4" @click="nextStep"> Save Changes </VBtn>
        ...
        <VWindowItem value="cash-on-delivery">
          <p class="text-base text-high-emphasis my-6">
            Cash on Delivery is a type of payment method where the recipient make payment for the order at the time of delivery rather than
            in advance.
          </p>
        ...
        <VWindowItem value="gift-card">
          <h6 class="text-base font-weight-medium mt-6">Enter Gift Card Details</h6>
          <VForm class="ms-n3">
            <VRow class="ma-0">
              <VCol cols="12">
                <AppTextField v-model="giftCardFormData.giftCardNumber" label="Gift Card Number" placeholder="1234 5678 9012 3456" />
              </VCol>
        ...
        <VCardText>
          <div class="d-flex justify-space-between text-base mb-2">
            ...
            <span class="font-weight-medium"
              >${{ checkoutPaymentDataLocal.orderAmount + checkoutPaymentDataLocal.deliveryCharges }}.00</span
            >
          </div>
