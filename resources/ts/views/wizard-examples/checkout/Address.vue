...
<template>
  <VRow>
    <VCol cols="12" md="8">
      ...
      <!-- 👉 Add New Address -->
      <VBtn variant="tonal" class="mt-4 mb-6" @click="isEditAddressDialogVisible = !isEditAddressDialogVisible"> Add New Address </VBtn>
      ...
      <VCard flat variant="outlined">
        ...
        <VCardText>
          ...
          <VList class="card-list">
            <VListItem v-for="product in checkoutAddressDataLocal.cartItems" :key="product.name">
              <template #prepend>
        ...
        <VCardText>
          ...
          <div class="d-flex align-center justify-space-between">
            ...
            <div class="text-end">
              <div v-if="checkoutAddressDataLocal.deliverySpeed === 'free'" class="d-flex align-center">
        ...
        <VCardText class="d-flex align-center justify-space-between text-high-emphasis">
          ...
          <span class="text-base font-weight-medium"> ${{ totalPriceWithDeliveryCharges }} </span>
        </VCardText>
      </VCard>
