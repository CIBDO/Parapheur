...
const offeredItems = ['iPhone 12 Pro Max', 'iPhone 12 Pro', 'iPhone 11 Pro Max', 'iPhone 11', 'iPhone 12 Mini', 'OnePlus Nord CE'];
...
<template>
  <VForm>
    <VRow>
      <VCol cols="12" sm="6">
        <AppTextField v-model="formData.title" label="Deal Title" placeholder="Black Friday Sale, 50% off on all products" />
      </VCol>
      ...
      <VCol cols="12" sm="6">
        <h6 class="text-body-2 text-high-emphasis mb-2">Notify Users</h6>
        ...
        <div class="d-flex align-center flex-wrap gap-x-3">
          ...
          <VCheckbox v-model="formData.notification.pushNotification" label="Push Notification" value="push-notification" />
        </div>
      </VCol>
    </VRow>
  </VForm>
