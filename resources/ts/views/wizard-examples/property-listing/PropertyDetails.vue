...
<template>
  <VForm>
    <VRow>
      ...
      <VCol cols="12" sm="6">
        <!-- 👉 Zip Code -->
        <AppTextField v-model="formData.zipCode" label="Zip Code" type="number" placeholder="123456" />
      </VCol>
      ...
      <VCol cols="12" sm="6">
        <!-- 👉 State -->
        <AppTextField v-model="formData.state" label="State" placeholder="California" />
      </VCol>

      <VCol cols="12" sm="6">
        <!-- 👉 City -->
        <AppTextField v-model="formData.city" label="City" placeholder="Los Angeles" />
      </VCol>

      <VCol cols="12" sm="6">
        <!-- 👉 Landmark -->
        <AppTextField v-model="formData.landmark" label="Landmark" placeholder="Nr. Hard Rock Cafe" />
      </VCol>
