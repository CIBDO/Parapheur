  ...
  <VRow>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          <p class="text-base clamp-text">Quickly collect the credit card details, built in input mask and form validation support.</p>

          <VBtn @click="isShareProjectDialogVisible = !isShareProjectDialogVisible"> Show </VBtn>
        </VCardText>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          ...
          <VBtn @click="isCardAddDialogVisible = !isCardAddDialogVisible"> Show </VBtn>
        </VCardText>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          <p class="text-base clamp-text">Elegant pricing options dialog popup example, easy to use in any page.</p>

          <VBtn @click="isPricingPlanDialogVisible = !isPricingPlanDialogVisible"> Show </VBtn>
        </VCardText>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          <p class="text-base clamp-text">Use Refer & Earn modal to encourage your exiting customers refer their friends & colleague.</p>

          <VBtn @click="isReferAndEarnDialogVisible = !isReferAndEarnDialogVisible"> Show </VBtn>
        </VCardText>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          <p class="text-base clamp-text">Ready to use form to collect user address data with validation and custom input support.</p>

          <VBtn @click="isEditAddressDialogVisible = !isEditAddressDialogVisible"> Show </VBtn>
        </VCardText>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          <p class="text-base clamp-text">Enhance your application security by enabling two factor authentication.</p>

          <VBtn @click="isTwoFactorDialogOpen = !isTwoFactorDialogOpen"> Show </VBtn>
        </VCardText>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          ...
          <VBtn @click="isUserInfoEditDialogVisible = !isUserInfoEditDialogVisible"> Show </VBtn>
        </VCardText>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          <p class="text-base clamp-text">Elegant payment options modal popup example, easy to use in any page.</p>

          <VBtn @click="isPaymentProvidersDialogVisible = !isPaymentProvidersDialogVisible"> Show </VBtn>
        </VCardText>
    ...
    <VCol cols="12" sm="6" md="4">
      <VCard class="text-high-emphasis text-center">
        ...
        <VCardText>
          <p class="text-base clamp-text">Elegant payment methods modal popup example, easy to use in any page.</p>

          <VBtn @click="isAddPaymentMethodsDialogVisible = !isAddPaymentMethodsDialogVisible"> Show </VBtn>
        </VCardText>
