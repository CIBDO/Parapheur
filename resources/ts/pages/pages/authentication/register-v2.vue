...
<template>
  ...
  <VRow no-gutters class="auth-wrapper bg-surface">
    ...
    <VCol cols="12" md="4" class="auth-card-v2 d-flex align-center justify-center">
      <VCard flat :max-width="500" class="mt-12 pa-6">
        <VCardText>
        ...
        <VCardText>
          <VForm @submit.prevent="() => {}">
            <VRow>
              <!-- Username -->
              <VCol cols="12">
                <AppTextField v-model="form.username" autofocus label="Username" placeholder="Johndoe" />
              </VCol>

              <!-- email -->
              <VCol cols="12">
                <AppTextField v-model="form.email" label="Email" type="email" placeholder="johndoe@email.com" />
              </VCol>
              ...
              <VCol cols="12" class="text-center text-base">
                ...
                <RouterLink class="text-primary ms-1 d-inline-block" :to="{ name: 'pages-authentication-login-v2' }">
                  Sign in instead
                </RouterLink>
              </VCol>
