  ...
  <VRow no-gutters class="auth-wrapper">
    <VCol md="4" class="d-none d-md-flex">
      ...
      <div class="d-flex justify-center align-center w-100 position-relative">
        ...
        <img class="bg-image position-absolute w-100 flip-in-rtl" :src="registerMultiStepBg" alt="register-multi-step-bg" height="340" />
      </div>
    </VCol>
    ...
    >
      <VCard flat class="mt-12 mt-sm-10">
        ...
        <VWindow v-model="currentStep" class="disable-tab-transition" style="max-inline-size: 681px">
          <VForm>
            <VWindowItem>
              <h4 class="text-h4">Account Information</h4>
              <p class="text-body-1 mb-6">Enter Your Account Details</p>
              ...
              <VRow>
                ...
                <VCol cols="12">
                  <AppTextField v-model="form.link" label="Profile Link" placeholder="https://profile.com/johndoe" type="url" />
                </VCol>
              </VRow>
            </VWindowItem>
            ...
            <VWindowItem>
              ...
              <VRow>
                ...
                <VCol cols="12">
                  <AppTextField v-model="form.address" label="Address" placeholder="1234 Main St, New York, NY 10001, USA" />
                </VCol>
            ...
            <VWindowItem>
              <h4 class="text-h4">Select Plan</h4>
              <p class="text-body-1 mb-5">Select plan as per your requirement</p>
              ...
              <h4 class="text-h4 mt-12">Payment Information</h4>
              <p class="text-body-1 mb-6">Enter your card information</p>

              <VRow>
                <VCol cols="12">
                  <AppTextField v-model="form.cardNumber" type="number" label="Card Number" placeholder="1234 1234 1234 1234" />
                </VCol>
        ...
        <div class="d-flex flex-wrap justify-space-between gap-x-4 mt-6">
          ...
          <VBtn v-if="items.length - 1 === currentStep" color="success" @click="onSubmit"> submit </VBtn>
