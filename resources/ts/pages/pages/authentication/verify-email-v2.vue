    ...
    <VCol md="8" class="d-none d-md-flex">
      <div class="position-relative bg-background w-100 me-0">
        <div class="d-flex align-center justify-center w-100 h-100" style="padding-inline: 150px">
          <VImg max-width="431" :src="authThemeImg" class="auth-illustration mt-16 mb-2" />
        </div>
      ...
      <VCard flat :max-width="500" class="mt-12 mt-sm-0 pa-6">
        <VCardText>
          ...
          <p class="text-body-1 mb-0">
            ...
            <span class="font-weight-medium text-high-emphasis">hello@example.com</span> Please follow the link inside to continue.
          </p>

          <VBtn block to="/" class="my-5"> Skip for now </VBtn>

          <div class="d-flex align-center justify-center"><span class="me-1">Didn't get the mail? </span><a href="#">Resend</a></div>
        </VCardText>
      </VCard>
    </VCol>
  </VRow>
