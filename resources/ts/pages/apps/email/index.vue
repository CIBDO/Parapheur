...
// Fetch Emails
const { data: emailData, execute: fetchEmails } = await useApi<any>(
...
const refreshOpenedEmail = async () => {
  ...
  if (openedEmail.value) openedEmail.value = emails.value.find(e => e.id === openedEmail.value?.id)!;
};
    ...
    <VMain>
      <VCard flat class="email-content-list h-100 d-flex flex-column">
        <div class="d-flex align-center">
          ...
          <!-- 👉 Search -->
          <VTextField v-model="q" density="default" class="email-search px-sm-2 flex-grow-1 py-1" placeholder="Search mail">
        ...
        <div class="py-2 px-4 d-flex align-center d-flex gap-x-1">
          ...
          <div
            ...
            :style="{
              visibility: isSelectAllEmailCheckboxIndeterminate || selectAllEmailCheckbox ? undefined : 'hidden',
            }"
          >
            <!-- Trash -->
            ...
            <IconBtn>
              ...
              <VTooltip activator="parent" location="top"> Folder </VTooltip>
