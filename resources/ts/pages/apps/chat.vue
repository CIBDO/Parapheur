  ...
  <VLayout class="chat-app-layout" style="z-index: 0">
    ...
    <VMain class="chat-content-container">
            ...
            <template #append-inner>
              <div class="d-flex gap-1">
                ...
                <div class="d-none d-md-block">
                  <VBtn append-icon="tabler-send" @click="sendMessage"> Send </VBtn>
                </div>
      ...
      <div v-else class="d-flex h-100 align-center justify-center flex-column">
        ...
        <VBtn v-if="$vuetify.display.smAndDown" rounded="pill" @click="startConversation"> Start Conversation </VBtn>
