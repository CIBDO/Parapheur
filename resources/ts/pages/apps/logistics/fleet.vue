...
<template>
  <VLayout class="fleet-app-layout">
    <VNavigationDrawer v-model="isLeftSidebarOpen" data-allow-mismatch width="360" absolute touchless location="start" border="none">
      <VCard class="h-100 fleet-navigation-drawer" flat>
        ...
        <!-- 👉 Perfect Scrollbar -->
        <PerfectScrollbar :options="{ wheelPropagation: false, suppressScrollX: true }" style="block-size: calc(100% - 60px)">
            ...
            <div v-for="(vehicle, index) in vehicleTrackingData" :key="index" class="mb-6">
              ...
              >
                <div class="d-flex gap-x-4 align-center">
                  <VAvatar icon="tabler-car" variant="tonal" color="secondary" />
                  <div>
                ...
                <IconBtn size="small">
                  <VIcon
                    :icon="
                      showPanel[index] ? 'tabler-chevron-down' : $vuetify.locale.isRtl ? 'tabler-chevron-left' : 'tabler-chevron-right'
                    "
                ...
                <div v-show="showPanel[index]">
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        <div class="ps-1">
                          <div class="text-caption text-success">TRACKING NUMBER CREATED</div>
                          <div class="app-timeline-title">
                            {{ vehicle.driverName }}
                          </div>
                          <div class="text-body-2">Sep 01, 7:53 AM</div>
                        </div>
                      </VTimelineItem>
                      ...
                      <VTimelineItem
                        ...
                        :elevation="0"
                      >
                        <div class="text-caption text-uppercase text-success">OUT FOR DELIVERY</div>
                        <div class="app-timeline-title">Veronica Herman</div>
                        <div class="text-body-2">Sep 03, 8:02 AM</div>
                      </VTimelineItem>
                      ...
                      <VTimelineItem
                        ...
                        :elevation="0"
                      >
                        <div class="text-caption text-uppercase text-success">ARRIVED</div>
                        <div class="app-timeline-title">Veronica Herman</div>
                        <div class="text-body-2">Sep 04, 8:18 AM</div>
                      </VTimelineItem>
                    </VTimeline>
                  </div>
                </div>
    ...
    <VMain>
      <div class="h-100">
        ...
        <img v-for="(car, index) in carImgs" :key="index" ref="refCars" :src="car" alt="car Img marker" height="42" width="20" />
      </div>
    </VMain>
  </VLayout>
</template>
