      ...
      <VLayout style="z-index: 0">
        ...
        >
          <div style="margin: 1.5rem">
            <VBtn block prepend-icon="tabler-plus" @click="isEventHandlerSidebarActive = true"> Add event </VBtn>
          </div>
          ...
          <div class="pa-6">
            ...
            <div class="d-flex flex-column calendars-checkbox">
              <VCheckbox id="check-all-events" v-model="checkAll" label="View all" />
              <VCheckbox
