    ...
    <VCol cols="12" md="3">
      <VCard class="mb-8">
        <VCardText>
          ...
          <VBtn block prepend-icon="tabler-send" class="mb-4" @click="isSendSidebarActive = true"> Send Invoice </VBtn>
          ...
          <div class="d-flex flex-wrap gap-4">
            ...
            <!-- 👉 Save button -->
            <VBtn color="secondary" variant="tonal" class="mb-4 flex-grow-1"> Save </VBtn>
          </div>

          <!-- 👉 Add Payment trigger button -->
          <VBtn block color="success" prepend-icon="tabler-currency-dollar" @click="isAddPaymentSidebarActive = true"> Add Payment </VBtn>
        </VCardText>
      </VCard>

      <!-- 👉 Accept payment via  -->
      <AppSelect id="payment-method" v-model="selectedPaymentMethod" :items="paymentMethods" label="Accept Payment Via" class="mb-4" />
