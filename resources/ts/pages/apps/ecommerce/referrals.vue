...
const resolveStatus = (status: string) => {
  if (status === 'Rejected') return { text: 'Rejected', color: 'error' };
  if (status === 'Unpaid') return { text: 'Unpaid', color: 'warning' };
  ...
  <div>
    ...
    <VRow class="match-height">
      ...
      <VCol cols="12" md="6">
        <VCard>
          <VCardItem>
            <VCardTitle class="mb-1"> How to use </VCardTitle>
            <VCardSubtitle> Integrate your referral code in 3 easy steps. </VCardSubtitle>
          </VCardItem>
          <VCardText>
      ...
      <VCol cols="12" md="6">
        <VCard>
          <VCardText>
            <div class="mb-5">
              <h5 class="text-h5 mb-5">Invite your friends</h5>
              <div class="d-flex align-center flex-wrap gap-4 flex-wrap">
                ...
                <VBtn class="align-self-end"> Submit </VBtn>
              </div>
            </div>

            <div>
              <h5 class="text-h5 mb-5">Share the referral link</h5>
              <div class="d-flex gap-4 align-center flex-wrap">
                <AppTextField label="Share referral link in social media" placeholder="pixinvent.com/?ref=6478" />
        ...
        <VCard>
          <VCardText>
            <div class="d-flex justify-space-between align-center flex-wrap gap-4">
              <h5 class="text-h5">Referred Users</h5>
              <div class="d-flex flex-wrap gap-4">
                <div class="d-flex gap-4 align-center flex-wrap">
                  <AppSelect v-model="itemsPerPage" :items="[10, 25, 50, 100]" style="inline-size: 100px" />
                  <VBtn prepend-icon="tabler-upload" color="default" variant="tonal"> Export </VBtn>
                </div>
              </div>
            </div>
          </VCardText>
              ...
              <div class="d-flex align-center gap-x-4">
                ...
                <div>
                  <div class="font-weight-medium text-high-emphasis">
                    <RouterLink :to="{ name: 'apps-ecommerce-customer-details-id', params: { id: 478426 } }" class="text-link">
                      {{ item.user }}
                    </RouterLink>
                  </div>
                  <div class="text-body-2">
