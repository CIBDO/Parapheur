...
onMounted(() => fetchTickets({ unassigned: 1, per_page: 50 }))
...
const headers = [
  ...
  { title: 'Demandeur', key: 'requester', width: '160px' },
...
async function doTakeCharge(item: any) {
  ...
  try {
    ...
    await fetchTickets({ unassigned: 1, per_page: 50 })
  }
  catch (e) {
    console.error(e)
  }
...
<template>
  <div>
    <ParapheurPageHeader
      title="Non affectés"
      subtitle="Tickets sans agent assigné"
    />
