...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We count all responses submitted through all forms in a month.If you already received 100 responses this month, you won't be able to receive any more of them until next month when the counter resets.",
  },
  {
    ...
    <VCard class="pricing-card">
        ...
        <VContainer>
          <div class="d-flex align-center flex-md-row flex-column position-relative">
            <div class="text-center text-md-start pb-5 px-10 px-sm-0 pt-8">
              <h4 class="text-h4 text-primary mb-2">Still not convinced? Start with a 14-day FREE trial!</h4>
              <p class="text-body-1 mb-11">You will get full access to all the features for 14 days.</p>
              <VBtn :to="{ name: 'front-pages-payment' }"> Start 14-day FREE trial </VBtn>
            </div>
      ...
      <VContainer>
        <VCardText class="text-center py-16 pricing-section">
          <h3 class="text-h3 mb-2">Pick a plan that works best for you</h3>
          <p class="text-body-1">Stay cool, we have a 48-hour money back guarantee!</p>
          <!-- 👉 Features & Tables -->
            ...
            <thead>
              <tr>
                <th scope="col" class="py-4">
                  <div>Features</div>
                  <div class="text-body-2">Native Font Features</div>
                </th>
                <th
                  v-for="{ plan, price } in [
                ...
                >
                  <div class="position-relative">
                    ...
                    >
                      <VIcon icon="tabler-star" size="14" color="white" />
                    </VAvatar>
                  </div>
            ...
            <tbody>
              <tr v-for="feature in features" :key="feature.feature">
                ...
                <td class="text-center">
                  <VAvatar variant="tonal" size="20" :color="feature.starter ? 'primary' : 'secondary'">
                    <VIcon
                  ...
                  <VChip v-if="feature.addOnAvailable.starter" color="primary" size="small" label> Add-On Available </VChip>
                </td>
                <td class="text-center">
                  <VChip v-if="feature.addOnAvailable.pro" color="primary" size="small" label> Add-On Available </VChip>
                  <VAvatar v-else size="20" variant="tonal" :color="feature.pro ? 'primary' : 'secondary'">
                    <VIcon :color="feature.pro ? 'primary' : 'secondary'" size="14" :icon="feature.pro ? 'tabler-check' : 'tabler-x'" />
                  </VAvatar>
                </td>
                <td class="text-center">
                  <VChip v-if="feature.addOnAvailable.enterprise" label color="primary" size="small"> Add-On Available </VChip>
                  <VAvatar v-else size="20" variant="tonal" :color="feature.enterprise ? 'primary' : 'disabled'">
                    <VIcon
            ...
            <tfoot>
              <tr>
                ...
                <td class="text-center py-2">
                  <VBtn variant="tonal" :to="{ name: 'front-pages-payment' }"> Choose Plan </VBtn>
                </td>
                <td class="text-center py-2">
                  <VBtn :to="{ name: 'front-pages-payment' }"> Choose Plan </VBtn>
                </td>
                <td class="text-center py-2">
                  <VBtn variant="tonal" :to="{ name: 'front-pages-payment' }"> Choose Plan </VBtn>
                </td>
        ...
        <VContainer>
          <VCardText class="py-10 py-sm-16 pricing-section">
            <div class="text-center">
              ...
              <p class="text-body-1 mb-6">Let us help answer the most common questions.</p>
            </div>
            <div>
              <VExpansionPanels>
                <VExpansionPanel v-for="(faq, index) in faqs" :key="faq.question" :title="faq.question" :text="faq.answer" :value="index" />
              </VExpansionPanels>
            </div>
          </VCardText>
        </VContainer>
