          ...
          <VRow>
            <VCol cols="12" md="7" :class="$vuetify.display.mdAndUp ? 'border-e' : 'border-b'">
              <VCardText class="pa-8 pe-5">
                ...
                <!-- billing Details -->
                <div class="mb-8">
                  <h4 class="text-h4 mb-6">Billing Details</h4>
                  <VForm>
                    <VRow>
                      <VCol cols="12" md="6">
                      ...
                      <VCol cols="12" md="6">
                        <AppSelect v-model="selectedCountry" label="Billing Country" :items="['USA', 'Canada', 'UK', 'AUS']" />
                      </VCol>
                      <VCol cols="12" md="6">
                ...
                <div class="mb-8" :class="selectedRadio === 'paypal' ? 'd-none' : 'd-block'">
                  <h4 class="text-h4 mb-6">Credit Card Info</h4>
                  <VRow>
                    <VCol cols="12">
            ...
            <VCol cols="12" md="5">
              <VCardText class="pa-8 ps-5">
                ...
                <div class="mb-8">
                  ...
                  <div class="text-body-1">It can help you manage and service orders before, during, and after fulfillment.</div>
                </div>
                ...
                <VCard flat color="rgba(var(--v-theme-on-surface), var(--v-hover-opacity))">
                  <VCardText>
                    ...
                    <VBtn variant="tonal" block @click="isPricingPlanDialogVisible = !isPricingPlanDialogVisible"> Change Plan </VBtn>
                  </VCardText>
                </VCard>
