      ...
      <div v-if="articleData && articleData?.title" class="article-section">
        <VRow>
          <VCol cols="12" md="8">
            <div>
              <VBreadcrumbs
                ...
                :items="[
                  { title: 'Help Center', to: { name: 'front-pages-help-center' }, class: 'text-primary' },
          ...
          <VCol cols="12" md="4">
            ...
            <div>
              <!-- 👉 Article List  -->
              <h5 class="text-h5 px-6 py-2 mb-4 rounded" style="background: rgba(var(--v-theme-on-surface), var(--v-hover-opacity))">
