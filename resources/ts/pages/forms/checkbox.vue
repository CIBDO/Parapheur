  ...
  <VRow class="match-height">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Density" :code="density">
        <p>
          Use <code>density</code> prop to reduces the input height. Available options are: <code>default</code>, <code>comfortable</code>,
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Model as array -->
      <AppCardCode title="Model as array" :code="modelAsArray">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Checkbox Value -->
      <AppCardCode title="Checkbox Value" :code="checkboxValue">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="States" :code="states">
        <p>
          <code>v-checkbox</code> can have different states such as <code>default</code>, <code>disabled</code>, and
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Inline text-field -->
      <AppCardCode title="Inline text-field" :code="inlineTextField">
