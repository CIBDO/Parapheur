...
<template>
  <VRow>
    <VCol cols="12">
      ...
      <AppCardCode title="Simple Form Validation" :code="simpleFormValidation">
    ...
    <VCol cols="12">
      ...
      <AppCardCode title="Validating Multiple Rules" :code="validatingMultipleRules">
    ...
    <VCol cols="12">
      <!-- 👉 Validation Types -->
      <AppCardCode title="Validation Types" :code="validationTypes">
