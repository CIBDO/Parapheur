  ...
  <VRow class="match-height">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Clearable" :code="clearable">
        <p>
          Use <code>clearable</code> prop to allows for the component to be cleared. Triggers when the icon containing the current value is
          clicked.
        </p>
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Readonly -->
      <AppCardCode title="Readonly" :code="readonly">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Hover -->
      <AppCardCode title="Hover" :code="hover">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Incremented -->
      <AppCardCode title="Incremented" :code="incremented">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Item slot -->
      <AppCardCode title="Item slot" :code="itemSlot">
