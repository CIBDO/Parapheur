...
<template>
  <VRow>
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Inset -->
      <AppCardCode title="Inset" :code="inset">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="True and False Value" :code="trueAndFalseValue">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="States" :code="states">
        <p>
          <code>v-switch</code> can have different states such as <code>default</code>, <code>disabled</code>, and <code>loading</code>.
        </p>
