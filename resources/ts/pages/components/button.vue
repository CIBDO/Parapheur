...
<template>
  <VRow>
    ...
    <VCol cols="12">
      <!-- 👉 Flat -->
      <AppCardCode title="Flat" :code="flat">
    ...
    <VCol cols="12">
      <!-- 👉 Rounded -->
      <AppCardCode title="Rounded" :code="rounded">
    ...
    <VCol cols="12">
      <!-- 👉 Text -->
      <AppCardCode title="Text" :code="text">
    ...
    <VCol cols="12">
      <!-- 👉 Plain -->
      <AppCardCode title="Plain" :code="plain">
        <p>
          Use <code>plain</code> variant option to a create a plain button. Plain buttons have a lower baseline opacity that reacts to hover
          and focus.
        </p>
        <DemoButtonPlain />
      </AppCardCode>
    ...
    <VCol cols="12">
      <!-- 👉 Icon -->
      <AppCardCode title="Icon" :code="icon">
    ...
    <VCol cols="12">
      <!-- 👉 Icon Only -->
      <AppCardCode title="Icon Only" :code="iconOnly">
    ...
    <VCol cols="12">
      <!-- 👉 Sizing -->
      <AppCardCode title="Sizing" :code="sizing">
    ...
    <VCol cols="12">
      <!-- 👉 Block  -->
      <AppCardCode title="Block" :code="block">
    ...
    <VCol cols="12">
      <!-- 👉 Loaders -->
      <AppCardCode title="Loaders" :code="loaders">
        <p>
          Using the <code>loading</code> prop, you can notify a user that there is processing taking place. The default behavior is to use a
    ...
    <VCol cols="12">
      <!-- 👉 Router -->
      <AppCardCode title="Router" :code="router">
    ...
    <VCol cols="12">
      <!-- 👉 Link -->
      <AppCardCode title="Link" :code="link">
    ...
    <VCol cols="12">
      <!-- 👉 Button Group -->
      <AppCardCode title="Group" :code="group">
        <p>
          Wrap buttons with the <code>v-btn-toggle</code> component to create a group button. You can add a visual divider between buttons
          with the <code>divided</code> prop.
        </p>
        <DemoButtonGroup />
      </AppCardCode>
    </VCol>
