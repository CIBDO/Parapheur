...
<template>
  <VRow class="match-height">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Elevated -->
      <AppCardCode title="Elevated" :code="elevated">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Chip With Icon -->
      <AppCardCode title="With Icon" :code="withIcon">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Avatar -->
      <AppCardCode title="With Avatar" :code="withAvatar">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Sizes -->
      <AppCardCode title="Sizes" :code="sizes">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 In Selects -->
      <AppCardCode title="In Selects" :code="inSelects">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Expandable -->
      <AppCardCode title="Expandable" :code="expandable">
