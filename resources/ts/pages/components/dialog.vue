...
<template>
  <VRow>
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Persistent -->
      <AppCardCode title="Persistent" :code="persistent">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Scrollable -->
      <AppCardCode title="Scrollable" :code="scrollable">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Loader -->
      <AppCardCode title="Loader" :code="loader">
    ...
    <VCol col="12" md="6">
      <!-- 👉 Nesting -->
      <AppCardCode title="Nesting" :code="nesting">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Overflowed -->
      <AppCardCode title="Overflowed" :code="overflowed">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Fullscreen -->
      <AppCardCode title="Fullscreen" :code="fullscreen">
        <p>
          Due to limited space, full-screen dialogs may be more appropriate for mobile devices than dialogs used on devices with larger
          screens.
        </p>
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Form -->
      <AppCardCode title="Form" :code="form">
