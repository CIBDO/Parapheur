...
<template>
  <VRow class="match-height">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Stacked -->
      <AppCardCode title="Stacked" variant="outlined" :code="stacked">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Vertical -->
      <AppCardCode title="Vertical" variant="outlined" :code="vertical">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Alignment -->
      <AppCardCode title="Alignment" variant="outlined" :code="alignment">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Pagination -->
      <AppCardCode title="Pagination" variant="outlined" :code="pagination">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Custom Icons -->
      <AppCardCode title="Custom Icons" variant="outlined" :code="customIcons">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Fixed tabs -->
      <AppCardCode title="Fixed" variant="outlined" :code="fixed">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Grow -->
      <AppCardCode title="Grow" variant="outlined" :code="grow">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Programmatic Navigation" variant="outlined" :code="programmaticNavigation">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Dynamic Tabs -->
      <AppCardCode title="Dynamic" variant="outlined" :code="dynamic">
        <p>
          Tabs can be dynamically added and removed. This allows you to update to any number and the <code>v-tabs</code> component will
          react.
        </p>
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Basic Pill -->
      <AppCardCode title="Basic Pill" variant="outlined" :code="basicPill">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Vertical Pill -->
      <AppCardCode title="Vertical Pill" variant="outlined" :code="verticalPill">
