...
<template>
  <VRow>
    ...
    <VCol cols="12">
      <!-- 👉 Events -->
      <AppCardCode title="Events" :code="events">
        <DemoTooltipEvents />
      </AppCardCode>
    </VCol>
    ...
    <VCol cols="12">
      <!-- 👉 Delay On Hover -->
      <AppCardCode title="Delay On Hover" :code="delayOnHover">
    ...
    <VCol cols="12">
      ...
      <AppCardCode title="Tooltip on Various Elements" :code="tooltipOnVariousElements">
