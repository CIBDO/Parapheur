...
<template>
  <VRow class="match-height">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Outline" :code="outline">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Circle -->
      <AppCardCode title="Circle" :code="circle">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Outline Circle" :code="outlineCircle">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Disabled -->
      <AppCardCode title="Disabled" :code="disabled">
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Length -->
      <AppCardCode title="Length" :code="length">
        <p>
          Using the <code>length</code> prop you can set the length of <code>v-pagination</code>, if the number of page buttons exceeds the
    ...
    <VCol cols="12" md="6">
      <!-- 👉 Total visible -->
      <AppCardCode title="Total visible" :code="totalVisible">
    ...
    <VCol cols="12" md="6">
      ...
      <AppCardCode title="Size" :code="size">
        <p>
          Use <code>size</code> prop to sets the height and width of the component. Default unit is px. Can also use the following
          predefined sizes: <strong>x-small</strong>, <strong>small</strong>, <strong>default</strong>, <strong>large</strong>, and
