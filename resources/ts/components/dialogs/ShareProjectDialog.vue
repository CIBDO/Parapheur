  ...
  >
    ...
    <VCard class="share-project-dialog pa-2 pa-sm-10">
      <VCardText>
        ...
        <p class="text-body-1 text-center mb-6">Share project with a team members</p>

        <AppAutocomplete label="Add Members" :items="membersList" item-title="name" item-value="name" placeholder="Add project members...">
