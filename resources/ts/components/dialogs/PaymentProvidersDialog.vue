  ...
  >
    ...
    <VCard class="pa-2 pa-sm-10">
      <VCardText>
        ...
        <p class="text-body-1 text-center mb-6">Third-party payment providers</p>
        ...
        <div v-for="(item, index) in paymentProvidersData" :key="index">
          <div class="d-flex flex-column flex-sm-row justify-space-between gap-4 flex-wrap py-4">
            ...
            <div class="d-flex gap-4 flex-wrap">
              <img v-for="(img, iterator) in item.providers" :key="iterator" :src="img.value" height="30" width="50" />
            </div>
          </div>
