...
<template>
  <VDialog :model-value="props.isDialogVisible" max-width="900" min-height="590" @update:model-value="dialogVisibleUpdate">
    <!-- 👉 dialog close btn -->
    ...
    <VCard class="create-app-dialog" min-height="590">
      <VCardText class="pa-5 pa-sm-16">
        ...
        <p class="text-body-1 text-center mb-6">Provide data with this form to create your app.</p>
        ...
        <VRow>
          ...
          <VCol cols="12" sm="7" md="8" lg="9">
            ...
            <div class="d-flex justify-space-between mt-6">
              ...
              <VBtn v-if="createApp.length - 1 === currentStep" color="success" @click="onSubmit"> submit </VBtn>
