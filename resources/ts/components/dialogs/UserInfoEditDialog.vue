  ...
  >
    ...
    <VCard class="pa-sm-10 pa-2">
      <VCardText>
        ...
        <p class="text-body-1 text-center mb-6">Updating user details will receive a privacy audit.</p>
        ...
        <VForm class="mt-6" @submit.prevent="onFormSubmit">
          <VRow>
            ...
            <!-- 👉 Status -->
            <VCol cols="12" md="6">
              <AppSelect v-model="userData.status" label="Status" placeholder="Active" :items="['Active', 'Inactive', 'Pending']" />
            </VCol>
            ...
            <!-- 👉 Contact -->
            <VCol cols="12" md="6">
              <AppTextField v-model="userData.contact" label="Phone Number" placeholder="+1 9876543210" />
            </VCol>
